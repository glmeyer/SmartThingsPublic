/**
 *  Sony Android TV Smartthings Integration, Currently testing on: XBR75X850D
 *  
...
metadata {
  definition (name: "Sony XBR Android TV", namespace: "pmjoen", author: "Patrick Mjoen") {
    capability "Switch"
    capability "Polling"
    capability "Refresh"
...
//		}
   ...
   standardTile("netflix", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
    ...
    standardTile("google", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
      state "default", label:"Google", action:"google", icon:"https://user-images.githubusercontent.com/8125308/33039759-b48250f4-cdfe-11e7-8263-7c771136a5b1.png"
    }
   ...
   state "default", label:"gguide", action:"gguide", icon:""
    ...
    standardTile("retu", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"return", action:"retu", icon:"https://user-images.githubusercontent.com/8125308/32848690-b5620b32-c9f2-11e7-8846-b5da0d80aebd.png"
    } 
    ...
    standardTile("num1", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num1", action:"num1", icon:"https://user-images.githubusercontent.com/8125308/33155387-0678187c-cfb6-11e7-9711-005ce5dae477.png"
    } 

    standardTile("num2", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num2", action:"num2", icon:"https://user-images.githubusercontent.com/8125308/33155394-1ab386e6-cfb6-11e7-8bed-843fdd3c7207.png"
    } 

    standardTile("num3", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num3", action:"num3", icon:"https://user-images.githubusercontent.com/8125308/33155399-284aa4c4-cfb6-11e7-963a-c81e2a110826.png"
    } 

    standardTile("num4", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num4", action:"num4", icon:"https://user-images.githubusercontent.com/8125308/33155417-365d66e6-cfb6-11e7-9f0e-e726cde30035.png"
    } 

    standardTile("num5", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num5", action:"num5", icon:"https://user-images.githubusercontent.com/8125308/33155431-55a4b5f4-cfb6-11e7-8cd9-0ccf3a8d2c63.png"
    } 

    standardTile("num6", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num6", action:"num6", icon:"https://user-images.githubusercontent.com/8125308/33155439-60ecdfcc-cfb6-11e7-9a8e-2f87fd96e0cf.png"
    } 

    standardTile("num7", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num7", action:"num7", icon:"https://user-images.githubusercontent.com/8125308/33155459-7e47e382-cfb6-11e7-8c0b-b54dfde6daa6.png"
    } 

    standardTile("num8", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num8", action:"num8", icon:"https://user-images.githubusercontent.com/8125308/33155474-901d94bc-cfb6-11e7-9413-4c7e7306b1d5.png"
    } 

    standardTile("num9", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num9", action:"num9", icon:"https://user-images.githubusercontent.com/8125308/33155484-9ed78008-cfb6-11e7-9aa8-b56ea271b5ff.png"
    } 

    standardTile("num0", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"num0", action:"num0", icon:"https://user-images.githubusercontent.com/8125308/33155518-c746df66-cfb6-11e7-9592-ced534d8bb1d.png"
    } 
    ...
    standardTile("ChannelUp", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"Channel", action:"ChannelUp", icon:"https://user-images.githubusercontent.com/8125308/33155732-a2c091da-cfb8-11e7-8c15-acfe797d22f7.png"
    }

    standardTile("ChannelDown", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
       state "default", label:"Channel", action:"ChannelDown", icon:"https://user-images.githubusercontent.com/8125308/33155722-88c80dee-cfb8-11e7-8c09-8a75f8dc147c.png"
    }
...
//  }
// Streaming view
      details(["switch","TVMulti","actionMenu","up","home","Pause","Play","left","confirm","right","Rewind","Forward","Prev","Next","Exit","down","retu","hdmi1", "hdmi2","refresh","netflix","google","picoff","hdmi3", "hdmi4"])
// TV View
//      details(["switch","num1", "num2", "num3", "num4", "num5", "ChannelUp", "num6", "num7", "num8", "num9", "num0", "ChannelDown","actionMenu","up","home","Pause","Play","left","confirm","right","Rewind","Forward","Prev","Next","Exit","down","retu","Mode3D","picoff","netflix","google","hdmi1","hdmi2","hdmi3", "hdmi4"])
  }
...
def setLevel(vol) { 
    ...
    state.remotecommand = "*SCVOLU0000000000000" + String.format('%03d',vol) 
    }
...
def google(){
	state.remotecommand ="AAAAAgAAAMQAAAA7Aw=="
    state.button = "Google"
	sendremotecommand()
}
